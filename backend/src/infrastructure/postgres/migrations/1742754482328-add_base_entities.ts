...
export class AddBaseEntities1742754482328 implements MigrationInterface {
    name = 'AddBaseEntities1742754482328'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "furniture" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "photos" json, "description" text, "body" text, "sellerType" "public"."furniture_sellertype_enum", "price" integer NOT NULL, "currency" "public"."furniture_currency_enum" NOT NULL DEFAULT 'UAH', "weight" text DEFAULT '0', "in_stock" boolean NOT NULL DEFAULT true, "discount" integer DEFAULT '0', "deleted" TIMESTAMP, "size_id" uuid NOT NULL, "brand_id" uuid NOT NULL, "category_id" uuid NOT NULL, "subcategory_id" uuid, CONSTRAINT "REL_b84ead66a803f885b2a6359319" UNIQUE ("size_id"), CONSTRAINT "PK_9dd4efe60df9de0ba0e443c2d33" PRIMARY KEY ("id"))`);
